        ...
        return Column(
          ...
          children: [
            ...
            const RegistrationStepQuestionsText(
              text:
                  'Select your most favorite hobby you enjoy now or during your childhood.',
            ),
            SizedBox(
              height: 8.h,
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  if (state.q6Hobby != null && state.q6Hobby?.id != '')
                    Flexible(
                      child: SelectedOption(
                        title: state.q6Hobby!.name.toString(),
                        onDelete: () {
                          context
                              .read<RegistrationQuestionsBloc>()
                              .add(UpdateQ6HobbyEvent(HobbyModel.idle()));
                        },
                      ),
                    )
                  else
            ...
            PrimaryButton(
              text: 'Next',
              onPressed: () {
                if (state.q6Hobby != null && state.q6Hobby!.id.isNotEmpty) {
                  context
                      .read<RegistrationQuestionsBloc>()
                      .add(NextStepEvent());
                } else {
