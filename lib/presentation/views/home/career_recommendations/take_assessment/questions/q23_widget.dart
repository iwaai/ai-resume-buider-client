...
class Q23Widget extends StatelessWidget {
  const Q23Widget({super.key});
      ...
      return Column(
        ...
        children: [
          TakeAssessmentQuestion(
            question: state.careerRecommendationQuestions[22].question,
          ),
          SizedBox(
            height: 8.h,
          ),
                ...
                return Expanded(
                  child: DialogSelectionTile(
                    ...
                    selected: state.answers[
                            state.careerRecommendationQuestions[22].id] ==
                        i,
                    onTap: () {
                      context.read<TakeAssessmentBloc>().add(SetAnswer(
                          state.careerRecommendationQuestions[22].id, i));
                    },
                  ),
                );
              },
          ...
          PrimaryButton(
              onPressed: () {
                if (state.answers[state.careerRecommendationQuestions[22].id] !=
                    null) {
