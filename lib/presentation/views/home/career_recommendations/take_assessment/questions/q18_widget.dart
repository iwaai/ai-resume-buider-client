...
class Q18Widget extends StatelessWidget {
  const Q18Widget({super.key});
      ...
      return Column(
        ...
        children: [
          TakeAssessmentQuestion(
            question: state.careerRecommendationQuestions[17].question,
          ),
          SizedBox(
            height: 8.h,
          ),
                ...
                return Expanded(
                  child: DialogSelectionTile(
                    ...
                    selected: state.answers[
                            state.careerRecommendationQuestions[17].id] ==
                        i,
                    onTap: () {
                      context.read<TakeAssessmentBloc>().add(SetAnswer(
                          state.careerRecommendationQuestions[17].id, i));
                    },
                  ),
                );
              },
          ...
          PrimaryButton(
              onPressed: () {
                if (state.answers[state.careerRecommendationQuestions[17].id] !=
                    null) {
