    ...
    switch (screen) {
      case AppRoutes.homeScreen:
        return {
          ...
          'body': !context.read<AppBloc>().state.user.isSubscriptionPaid
              ? 'Thank you for trying out ResuMate. Your free access lets you try out our AI Resume Builder Module. Click anywhere else on the screen to subscribe and get access to all modules.'
