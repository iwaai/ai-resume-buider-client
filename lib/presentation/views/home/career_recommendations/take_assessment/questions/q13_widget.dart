...
class Q13Widget extends StatelessWidget {
      ...
      return Column(
        ...
        children: [
          TakeAssessmentQuestion(
            question: state.careerRecommendationQuestions[12].question,
          ),
          SizedBox(
            height: 8.h,
          ),
                ...
                return Expanded(
                  child: DialogSelectionTile(
                    ...
                    selected: state.answers[
                            state.careerRecommendationQuestions[12].id] ==
                        i,
                    onTap: () {
                      context.read<TakeAssessmentBloc>().add(SetAnswer(
                          state.careerRecommendationQuestions[12].id, i));
                    },
                  ),
                );
              },
          ...
          PrimaryButton(
              onPressed: () {
                if (state.answers[state.careerRecommendationQuestions[12].id] !=
                    null) {
