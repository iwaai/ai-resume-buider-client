...
class CreateGoalScreen extends StatelessWidget {
  ...
  void _showGoalCreatedDialog(
    ...
    CommonDialog(
      ...
      body:
          'Your goal has been successfully created. You can now monitor your progress and take the necessary steps to achieve it. Stay committed to your objectives and continue striving for success. if you have any questions, contact info@yoursecondshot.com',
