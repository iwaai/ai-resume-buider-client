      ...
      return Column(
        ...
        children: [
          TakeAssessmentQuestion(
            question: state.careerRecommendationQuestions[8].question,
          ),
          SizedBox(
            height: 8.h,
          ),
            ...
            children: [
              Expanded(
                child: DialogSelectionTile(
                  text: 'Inside',
                  selected: state
                          .answers[state.careerRecommendationQuestions[8].id] ==
                      "Inside",
                  onTap: () {
                    context.read<TakeAssessmentBloc>().add(SetAnswer(
                        state.careerRecommendationQuestions[8].id, 'Inside'));
                  },
                ),
              ),
              Expanded(
                child: DialogSelectionTile(
                  ...
                  onTap: () {
                    context.read<TakeAssessmentBloc>().add(SetAnswer(
                        state.careerRecommendationQuestions[8].id, 'Outside'));
                  },
                ),
              ),
            ],
          ...
          PrimaryButton(
              onPressed: () {
                if (state.answers[state.careerRecommendationQuestions[8].id] !=
                    null) {
