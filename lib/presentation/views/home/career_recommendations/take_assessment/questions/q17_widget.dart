...
class Q17Widget extends StatelessWidget {
  const Q17Widget({super.key});
      ...
      return Column(
        ...
        children: [
          TakeAssessmentQuestion(
            question: state.careerRecommendationQuestions[16].question,
          ),
          SizedBox(
            height: 8.h,
          ),
              ...
              (index) {
                ...
                return Expanded(
                  ...
                  selected: state.answers[
                          state.careerRecommendationQuestions[16].id] ==
                      i,
                  onTap: () {
                    context.read<TakeAssessmentBloc>().add(SetAnswer(
                        state.careerRecommendationQuestions[16].id, i));
                  },
                ));
              },
            ),
          ...
          PrimaryButton(
              onPressed: () {
                if (state.answers[state.careerRecommendationQuestions[16].id] !=
                    null) {
