      ...
      return Column(
        ...
        children: [
          TakeAssessmentQuestion(
            question: state.careerRecommendationQuestions[7].question,
          ),
          SizedBox(
            height: 8.h,
          ),
                ...
                return Expanded(
                  child: DialogSelectionTile(
                    ...
                    selected: state.answers[
                            state.careerRecommendationQuestions[7].id] ==
                        i,
                    onTap: () {
                      context.read<TakeAssessmentBloc>().add(SetAnswer(
                          state.careerRecommendationQuestions[7].id, i));
                    },
                  ),
                );
              },
          ...
          PrimaryButton(
              onPressed: () {
                if (state.answers[state.careerRecommendationQuestions[7].id] !=
                    null) {
