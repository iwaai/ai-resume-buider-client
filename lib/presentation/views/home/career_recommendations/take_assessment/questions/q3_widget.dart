        ...
        return Column(
          ...
          children: [
            TakeAssessmentQuestion(
              question: state.careerRecommendationQuestions[2].question,
            ),
            SizedBox(
              height: 8.h,
            ),
            PrimaryDropdown(
              ...
              initialValue:
                  state.answers[state.careerRecommendationQuestions[2].id],
              hintText: 'Select Your Answer',
              onChanged: (newValue) {
                context.read<TakeAssessmentBloc>().add(
                      SetAnswer(
                          state.careerRecommendationQuestions[2].id, newValue),
                    );
              },
            ),
            const Spacer(),
            PrimaryButton(
                onPressed: () {
                  if (state
                          .answers[state.careerRecommendationQuestions[2].id] !=
                      null) {
